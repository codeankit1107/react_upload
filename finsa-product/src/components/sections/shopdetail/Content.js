                                    ...
                                    <div className="add-to-cart-form">
                                        <form action="#">
                                            <div className="quantity-input">
                                                <div className="quantity-down" id="quantityDown" onClick={this.DecreaseItem}>
                                                    <i className="fal fa-minus" />
                                                </div>
                                                <input id="quantity" disabled type="text" value={this.state.clicks} onChange={this.handleChange.bind(this)} name="quantity" />
                                                <div className="quantity-up" id="quantityUP" onClick={this.IncrementItem}>
